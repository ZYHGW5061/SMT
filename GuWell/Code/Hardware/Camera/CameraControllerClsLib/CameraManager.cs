    ...
    public class CameraManager
    {
        ...
        public bool InitializeCameras()
        {
            ...
            foreach (var item in configs)
            {
                ...
                //Initialize camera
                camera.Connect();
                camera.ExposureTime = item.ExposureTime;
                camera.Gain = item.Gain;
                camera.FPS = item.FPS;
                //if (item.ImageType == EnumImageData.Grey)
                //{
                //    camera.PixelFormat = System.Drawing.Imaging.PixelFormat.Format8bppIndexed;
                //}
                //else
                //{
                //    camera.PixelFormat = System.Drawing.Imaging.PixelFormat.Format24bppRgb;
                //}
