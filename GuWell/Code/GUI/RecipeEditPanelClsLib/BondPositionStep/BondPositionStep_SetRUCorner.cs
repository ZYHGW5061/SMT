...
{
    public partial class BondPositionStep_SetRUCorner : BondPositionStepBasePage
    {
        public BondPositionStep_SetRUCorner()
        {
            InitializeComponent();
        }
        ...
        { 
            get 
            { return EnumDefineSetupRecipeBondPositionStep.SetSubmountRightUpperCorner; } 
        }
        /// <summary>
        ///  加载前一步定义的Recipe对象
        /// </summary>
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeBondPositionStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeBondPositionStep.SetSubmountRightUpperCorner;
