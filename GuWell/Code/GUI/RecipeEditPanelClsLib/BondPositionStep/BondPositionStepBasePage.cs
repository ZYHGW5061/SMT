...
namespace RecipeEditPanelClsLib
{
    ...
    /// 单步定义recipe的UI交互基类
    /// </summary>
    public class BondPositionStepBasePage : XtraUserControl
    {
        /// <summary>
        /// 定位系统
        /// </summary>
        ...
        public virtual EnumDefineSetupRecipeBondPositionStep CurrentStep { get; }
        ...
        /// <summary>
        /// 贴片位置相对于视野中心的坐标(正方向向右向下)
        /// </summary>
        public XYZTCoordinateConfig BondPositionOffset { get; set; }
        public XYZTCoordinateConfig BondPositionCompensation { get; set; }
        /// <summary>
        /// 识别特征相对于视野中心的偏移mm
        /// </summary>
        public XYZTCoordinateConfig PatternPositionOffsetWithVisionCenter { get; set; }

        /// <summary>
        /// 特征的系统坐标系位置
        /// </summary>
        public PointF PositionOfCreatePattern { get; set; }
        public float PPWorkHeight { get; set; }
        public float BondPositionTopplateHigherValueThanMarkTopplate { get; set; }
        /// <summary>
        /// 上一步的页面Id
        /// </summary>
        ...
        /// 验证单步定义是否完成
        /// </summary>
        public virtual void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeBondPositionStep currengStep) 
        { finished = false; currengStep = EnumDefineSetupRecipeBondPositionStep.None; }
