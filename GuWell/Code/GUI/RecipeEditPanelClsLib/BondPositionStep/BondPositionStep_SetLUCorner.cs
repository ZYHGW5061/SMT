...
{
    public partial class BondPositionStep_SetLUCorner : BondPositionStepBasePage
    {
        public BondPositionStep_SetLUCorner()
        {
            InitializeComponent();
        }
        ...
        { 
            get 
            { return EnumDefineSetupRecipeBondPositionStep.SetSubmountLeftUpperCorner; } 
        }
        /// <summary>
        ///  加载前一步定义的Recipe对象
        /// </summary>
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeBondPositionStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeBondPositionStep.SetSubmountLeftUpperCorner;
