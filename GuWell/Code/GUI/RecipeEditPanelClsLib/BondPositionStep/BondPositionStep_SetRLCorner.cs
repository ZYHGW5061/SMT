...
{
    public partial class BondPositionStep_SetRLCorner : BondPositionStepBasePage
    {
        public BondPositionStep_SetRLCorner()
        {
            InitializeComponent();
        }
        ...
        { 
            get 
            { return EnumDefineSetupRecipeBondPositionStep.SetSubmountRightLowerCorner; } 
        }
        /// <summary>
        ///  加载前一步定义的Recipe对象
        /// </summary>
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeBondPositionStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeBondPositionStep.SetSubmountRightLowerCorner;
