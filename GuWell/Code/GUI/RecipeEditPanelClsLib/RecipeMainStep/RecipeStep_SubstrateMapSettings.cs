...
namespace RecipeEditPanelClsLib
{
    public partial class RecipeStep_SubstrateMapSettings : RecipeStepBase
    {
        ...
        public override void LoadEditedRecipe(BondRecipe recipe)
        {
            ...
            FirstMaterialPosition = new PointF((float)_editRecipe.CurrentSubstrate.FirstSubstrateHomeSystemLocation.X, (float)_editRecipe.CurrentSubstrate.FirstSubstrateHomeSystemLocation.Y);
        ...
        public override void VertifyAndNotifySingleStepDefineFinished(out bool finished, out EnumRecipeStep currengStep)
        {
            ...
            _editRecipe.CurrentSubstrate.RowCount = _numbersofRows;
            _editRecipe.CurrentSubstrate.ColumnCount = _numbersofColumns;
            _editRecipe.CurrentSubstrate.PitchColumnMM = _columnPitchMM;
            _editRecipe.CurrentSubstrate.PitchRowMM = _rowPitchMM;

            _editRecipe.CurrentSubstrate.FirstSubstrateHomeSystemLocation.X = FirstMaterialPosition.X;
            _editRecipe.CurrentSubstrate.FirstSubstrateHomeSystemLocation.Y = FirstMaterialPosition.Y;
            _editRecipe.CurrentSubstrate.IsMaterialMapSettingsComplete = true;
                    ...
                    if (_rowPitchMM != 0 && _columnPitchMM != 0)
                    {
                        ...
                        for (int i = 0; i < _numbersofColumns; i++)
                        {
                            for (int j = 0; j < _numbersofRows; j++)
                            {
                                ...
                                material.IsProcess = true;
                                material.Properties = MaterialProperties.Testable;
                                _editRecipe.CurrentSubstrate.SubstrateMapInfos.Add(material);
                            }
                        }
                    }
                }
