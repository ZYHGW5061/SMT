...
{
    public partial class RecipeStep_ComponentCalibrationAfterPPSettings : RecipeStepBase
    {
        ...
        public RecipeStep_ComponentCalibrationAfterPPSettings()
        {
            InitializeComponent();
        ...
        private ComponentCalibrationAfterPPStepBasePage currentStepPage;
        /// <summary>
        /// 定位系统
        /// </summary>
        ...
        { 
            ...
            if (_editRecipe.CurrentComponent.CalibrationAfterPPMarkPointCount == 2)
            {
        ...
        { 
            ...
            _editRecipe.CurrentComponent.IsMaterialCalibrationAfterPPSettingsComplete = true;
            finished = true;
        }
        ...
        private void InitialCameraControl()
        {
            ...
            //}
            //else if (_editRecipe.CurrentComponent.CalibrationAfterPPComponentPositionVisionParameters.VisionPositionUsedCamera == EnumCameraType.WaferCamera)
            //{
        ...
        private void LoadPreviousStepPage()
        {
            ...
            {
                var finished = false;
                var step = EnumDefineSetupRecipeComponentCalibrationAfterPPStep.None;
            ...
            {
                this.panelStepOperate.Controls.Clear();
                currentStepPage = new ComponentCalibrationAfterPPStep_WorkHeight();
            ...
            if (_editRecipe.CurrentComponent.CalibrationAfterPPMarkPointCount == 2)
            {
                if (currentStepPage.CurrentStep == EnumDefineSetupRecipeComponentCalibrationAfterPPStep.VisionPosition2)
                {
            ...
            {
                if (currentStepPage.CurrentStep == EnumDefineSetupRecipeComponentCalibrationAfterPPStep.VisionPosition)
                {
                    this.btnNext.Text = "完成";
                }
                else
            ...
            //if (currentStepPage.CurrentStep == EnumDefineSetupRecipeComponentCalibrationAfterPPStep.SetWorkHeight)
            //{
            ...
            //}
            if (currentStepPage.CurrentStep == EnumDefineSetupRecipeComponentCalibrationAfterPPStep.SetComponentLeftUpperCorner)
            {
                this.btnPrevious.Visible = false;
            }
            else
        ...
        private void LoadNextStepPage()
        {
            if (currentStepPage != null)
            {
                ...
                if (_editRecipe.CurrentComponent.CalibrationAfterPPMarkPointCount == 2)
                {
                    if (step != EnumDefineSetupRecipeComponentCalibrationAfterPPStep.VisionPosition2)
                    {
                        this.panelStepOperate.Controls.Clear();
                        currentStepPage = GenerateStepPage(currentStepPage.CurrentStep + 1);
                        currentStepPage.Dock = DockStyle.Fill;
                ...
                {
                    if (step != EnumDefineSetupRecipeComponentCalibrationAfterPPStep.VisionPosition)
                    {
                        this.panelStepOperate.Controls.Clear();
                        currentStepPage = GenerateStepPage(currentStepPage.CurrentStep + 1);
                        currentStepPage.Dock = DockStyle.Fill;
            ...
            {
                this.panelStepOperate.Controls.Clear();
                currentStepPage = new ComponentCalibrationAfterPPStep_SizeLUCorner();
            ...
            //    ((ComponentCalibrationAfterPPStep_VisionPosition)currentStepPage).InitializeVisionTool(_VisualManager.GetCameraByID(EnumCameraType.BondCamera));
            //}
            //else
            //{
        ...
        private ComponentCalibrationAfterPPStepBasePage GenerateStepPage(EnumDefineSetupRecipeComponentCalibrationAfterPPStep step)
        {
            var ret = new ComponentCalibrationAfterPPStepBasePage();
            switch (step)
            {
                case EnumDefineSetupRecipeComponentCalibrationAfterPPStep.None:
                    break;
                //case EnumDefineSetupRecipeComponentCalibrationAfterPPStep.SetWorkHeight:
                //    ret = new ComponentCalibrationAfterPPStep_WorkHeight();
                //    break;
                case EnumDefineSetupRecipeComponentCalibrationAfterPPStep.SetComponentLeftUpperCorner:
                    ret = new ComponentCalibrationAfterPPStep_SizeLUCorner();
                    break;
                case EnumDefineSetupRecipeComponentCalibrationAfterPPStep.SetComponentRightUpperCorner:
                    ret = new ComponentCalibrationAfterPPStep_SizeRUCorner();
                    break;
                case EnumDefineSetupRecipeComponentCalibrationAfterPPStep.SetComponentRightLowerCorner:
                    ret = new ComponentCalibrationAfterPPStep_SizeRLCorner();
                    break;
                case EnumDefineSetupRecipeComponentCalibrationAfterPPStep.SetComponentLeftLowerCorner:
                    ret = new ComponentCalibrationAfterPPStep_SizeLLCorner();
                    break;
                case EnumDefineSetupRecipeComponentCalibrationAfterPPStep.VisionPosition:
                    ret = new ComponentCalibrationAfterPPStep_VisionPosition(_parentCameraWnd);
                    break;
                default:
                    break;
            }
        ...
        private void SaveStepParametersWhenStepFinished(EnumDefineSetupRecipeComponentCalibrationAfterPPStep step)
        {
            switch (step)
            {
                case EnumDefineSetupRecipeComponentCalibrationAfterPPStep.None:
                ...
                case EnumDefineSetupRecipeComponentCalibrationAfterPPStep.SetComponentLeftLowerCorner:
                    ...
                    var usedCamera = _editRecipe.CurrentComponent.CalibrationAfterPPComponentPositionVisionParameters.VisionPositionUsedCamera;
                    ...
                    break;
                case EnumDefineSetupRecipeComponentCalibrationAfterPPStep.VisionPosition:
                    var shapeMatchParam = _editRecipe.CurrentComponent.CalibrationAfterPPComponentPositionVisionParameters.ShapeMatchParameters.FirstOrDefault();
                    ...
                    break;
                case EnumDefineSetupRecipeComponentCalibrationAfterPPStep.VisionPosition2:
                    var shapeMatchParam2 = _editRecipe.CurrentComponent.CalibrationAfterPPComponentPositionVisionParameters.ShapeMatchParameters[1];
