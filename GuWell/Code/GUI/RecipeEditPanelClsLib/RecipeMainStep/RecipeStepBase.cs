...
namespace RecipeEditPanelClsLib
{
    ...
    /// 单步定义recipe的UI交互基类
    /// </summary>
    public class RecipeStepBase : XtraUserControl, IRecipeStepBase
    {
        /// <summary>
        /// Recipe对象
        /// </summary>
        protected BondRecipe _editRecipe;
        ...
        public virtual void LoadEditedRecipe(BondRecipe recipe) { _editRecipe = recipe; }
