...
{
    public partial class SubstrateMapStep_PositionFirstSubstrate : SubstrateMapStepBasePage
    {
        ...
        public SubstrateMapStep_PositionFirstSubstrate()
        {
            InitializeComponent();
        }
        ...
        {
            get
            { return EnumDefineSetupRecipeSubstrateMapStep.SetFirstMaterialPos; }
        }
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeSubstrateMapStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeSubstrateMapStep.SetFirstMaterialPos;
                ...
                FirstSubmountPosition = new PointF(posX, posY);
                finished = true;
            }
            finally
            {
