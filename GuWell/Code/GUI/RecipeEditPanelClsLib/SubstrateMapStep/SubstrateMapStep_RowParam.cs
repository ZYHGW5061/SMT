...
{
    public partial class SubstrateMapStep_RowParam : SubstrateMapStepBasePage
    {
        ...
        public SubstrateMapStep_RowParam()
        {
            InitializeComponent();
        }
        ...
        {
            get
            { return EnumDefineSetupRecipeSubstrateMapStep.SetRowMap; }
        }
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeSubstrateMapStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeSubstrateMapStep.SetRowMap;
                ...
                LastRowSubmountPosition = new PointF(posX, posY);
                finished = true;
            }
            finally
            {
