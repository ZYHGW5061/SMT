...
namespace RecipeEditPanelClsLib
{
    ...
    /// 单步定义recipe的UI交互基类
    /// </summary>
    public class DispenserSettingsStepBasePage : XtraUserControl
    {
        ...
        public virtual EnumDefineDispenserSettingsStep CurrentStep { get; }

        public PointF DispenserPosition { get; set; }
        public PointF DispenserPositionOffsetWithBondCamera { get; set; }

        public float DispenserWorkHeight { get; set; }
        ...
        /// 验证单步定义是否完成
        /// </summary>
        public virtual void NotifyStepFinished(out bool finished, out EnumDefineDispenserSettingsStep currengStep) 
        { finished = false; currengStep = EnumDefineDispenserSettingsStep.None; }
