...
{
    public partial class ModulePositionStep_SetLUCorner : ModulePositionStepBasePage
    {
        private PackagedLightController _packagedLightController;
        public ModulePositionStep_SetLUCorner()
        {
            InitializeComponent();
        }
        ...
        { 
            get 
            { return EnumDefineSetupRecipeModulePositionStep.SetLeftUpperCorner; } 
        }
        /// <summary>
        ///  加载前一步定义的Recipe对象
        /// </summary>
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeModulePositionStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeModulePositionStep.SetLeftUpperCorner;
