...
{
    public partial class ModulePositionStep_SetRLCorner : ModulePositionStepBasePage
    {
        private PackagedLightController _packagedLightController;
        public ModulePositionStep_SetRLCorner()
        {
            InitializeComponent();
        }
        ...
        { 
            get 
            { return EnumDefineSetupRecipeModulePositionStep.SetRightLowerCorner; } 
        }
        /// <summary>
        ///  加载前一步定义的Recipe对象
        /// </summary>
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeModulePositionStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeModulePositionStep.SetRightLowerCorner;
