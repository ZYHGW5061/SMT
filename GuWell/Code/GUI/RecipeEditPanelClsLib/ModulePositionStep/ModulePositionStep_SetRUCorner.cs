...
{
    public partial class ModulePositionStep_SetRUCorner : ModulePositionStepBasePage
    {
        private PackagedLightController _packagedLightController;
        public ModulePositionStep_SetRUCorner()
        {
            InitializeComponent();
        }
        ...
        { 
            get 
            { return EnumDefineSetupRecipeModulePositionStep.SetRightUpperCorner; } 
        }
        /// <summary>
        ///  加载前一步定义的Recipe对象
        /// </summary>
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeModulePositionStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeModulePositionStep.SetRightUpperCorner;
