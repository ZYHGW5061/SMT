...
namespace RecipeEditPanelClsLib
{
    ...
    /// 单步定义recipe的UI交互基类
    /// </summary>
    public class SubstratePositionStepBasePage : XtraUserControl
    {
        /// <summary>
        /// 定位系统
        /// </summary>
        ...
        public virtual EnumDefineSetupRecipeSubstratePositionStep CurrentStep { get; }
        ...
        //基板表面比Mark表面高了多少
        public float SubstrateTopplateHigherValueThanMarkTopplate { get; set; }
        /// <summary>
        /// 特征的系统坐标系位置
        /// </summary>
        ...
        /// 验证单步定义是否完成
        /// </summary>
        public virtual void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeSubstratePositionStep currengStep) 
        { finished = false; currengStep = EnumDefineSetupRecipeSubstratePositionStep.None; }
