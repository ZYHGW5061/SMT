...
{
    public partial class SubstratePositionStep_SetLUCorner : SubstratePositionStepBasePage
    {
        private PackagedLightController _packagedLightController;
        public SubstratePositionStep_SetLUCorner()
        {
            InitializeComponent();
        }
        ...
        { 
            get 
            { return EnumDefineSetupRecipeSubstratePositionStep.SetLeftUpperCorner; } 
        }
        /// <summary>
        ///  加载前一步定义的Recipe对象
        /// </summary>
        ...
        public override void LoadEditedRecipe(BondRecipe recipe)
        {
            try
            {
                if (recipe == null)
                {
                    throw new Exception("Recipe is null when execute SubmountPositionStep_SetLUCorner LoadEditedRecipe.");
                }
                EditRecipe = recipe;
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeSubstratePositionStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeSubstratePositionStep.SetLeftUpperCorner;
