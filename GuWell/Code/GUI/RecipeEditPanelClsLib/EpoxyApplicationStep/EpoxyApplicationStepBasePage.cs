...
namespace RecipeEditPanelClsLib
{
    ...
    /// 单步定义recipe的UI交互基类
    /// </summary>
    public class EpoxyApplicationStepBasePage : XtraUserControl
    {
        ...
        public virtual EnumDefineEpoxyApplicationStep CurrentStep { get; }
        ...
        /// 验证单步定义是否完成
        /// </summary>
        public virtual void NotifyStepFinished(out bool finished, out EnumDefineEpoxyApplicationStep currengStep) 
        { finished = false; currengStep = EnumDefineEpoxyApplicationStep.None; }
