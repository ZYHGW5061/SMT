...
namespace RecipeEditPanelClsLib
{
    ...
    /// 单步定义recipe的UI交互基类
    /// </summary>
    public class ComponentPositionStepBasePage : XtraUserControl
    {
        ...
        public virtual EnumDefineSetupRecipeComponentPositionStep CurrentStep { get; }
        ...
        /// 验证单步定义是否完成
        /// </summary>
        public virtual void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentPositionStep currengStep) 
        { finished = false; currengStep = EnumDefineSetupRecipeComponentPositionStep.None; }
