...
{
    public partial class ComponentPositionStep_SizeRUCorner : ComponentPositionStepBasePage
    {
        ...
        public ComponentPositionStep_SizeRUCorner()
        {
            InitializeComponent();
        }
        ...
        {
            get
            { return EnumDefineSetupRecipeComponentPositionStep.SetComponentRightUpperCorner; }
        }
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentPositionStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeComponentPositionStep.SetComponentRightUpperCorner;
