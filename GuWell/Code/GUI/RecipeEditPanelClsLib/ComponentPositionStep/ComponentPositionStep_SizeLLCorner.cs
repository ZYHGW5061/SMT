...
{
    public partial class ComponentPositionStep_SizeLLCorner : ComponentPositionStepBasePage
    {
        ...
        public ComponentPositionStep_SizeLLCorner()
        {
            InitializeComponent();
        }
        ...
        {
            get
            { return EnumDefineSetupRecipeComponentPositionStep.SetComponentLeftLowerCorner; }
        }
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentPositionStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeComponentPositionStep.SetComponentLeftLowerCorner;
