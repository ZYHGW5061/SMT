...
{
    public partial class ComponentPositionStep_SizeLUCorner : ComponentPositionStepBasePage
    {
        ...
        public ComponentPositionStep_SizeLUCorner()
        {
            InitializeComponent();
        }
        ...
        {
            get
            { return EnumDefineSetupRecipeComponentPositionStep.SetComponentLeftUpperCorner; }
        }
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentPositionStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeComponentPositionStep.SetComponentLeftUpperCorner;
