...
{
    public partial class ComponentCalibrationAfterPPStep_SizeLLCorner : ComponentCalibrationAfterPPStepBasePage
    {
        ...
        public ComponentCalibrationAfterPPStep_SizeLLCorner()
        {
            InitializeComponent();
        }
        ...
        {
            get
            { return EnumDefineSetupRecipeComponentCalibrationAfterPPStep.SetComponentLeftLowerCorner; }
        }
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentCalibrationAfterPPStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeComponentCalibrationAfterPPStep.SetComponentLeftLowerCorner;
