...
namespace RecipeEditPanelClsLib
{
    ...
    /// 单步定义recipe的UI交互基类
    /// </summary>
    public class ComponentCalibrationAfterPPStepBasePage : XtraUserControl
    {
        ...
        public virtual EnumDefineSetupRecipeComponentCalibrationAfterPPStep CurrentStep { get; }
        ...
        public float ChipTopplateHigherValueThanMarkTopplate { get; set; }
        public float ESWorkHeight { get; set; }
        /// <summary>
        /// 上一步的页面Id
        /// </summary>
        ...
        /// 验证单步定义是否完成
        /// </summary>
        public virtual void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentCalibrationAfterPPStep currengStep) 
        { finished = false; currengStep = EnumDefineSetupRecipeComponentCalibrationAfterPPStep.None; }
