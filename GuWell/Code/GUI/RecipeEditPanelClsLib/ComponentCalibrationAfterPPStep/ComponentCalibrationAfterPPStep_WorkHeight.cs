...
{
    public partial class ComponentCalibrationAfterPPStep_WorkHeight : ComponentCalibrationAfterPPStepBasePage
    {
        private PackagedLightController _packagedLightController;
        public ComponentCalibrationAfterPPStep_WorkHeight()
        {
            InitializeComponent();
        }
        /// <summary>
        ...
        { 
            get 
            { return EnumDefineSetupRecipeComponentCalibrationAfterPPStep.SetWorkHeight; } 
        }
        /// <summary>
        /// 定位系统
        /// </summary>
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentCalibrationAfterPPStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeComponentCalibrationAfterPPStep.SetWorkHeight;
                finished = true;
            }
            finally
            {
