...
{
    public partial class ComponentCalibrationAfterPPStep_SizeLUCorner : ComponentCalibrationAfterPPStepBasePage
    {
        ...
        public ComponentCalibrationAfterPPStep_SizeLUCorner()
        {
            InitializeComponent();
        }
        ...
        {
            get
            { return EnumDefineSetupRecipeComponentCalibrationAfterPPStep.SetComponentLeftUpperCorner; }
        }
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentCalibrationAfterPPStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeComponentCalibrationAfterPPStep.SetComponentLeftUpperCorner;
                ...
                {
                    LeftUpperCornerCoor = new PointF((float)_positioningSystem.ReadCurrentSystemPosition(EnumStageAxis.BondX), (float)_positioningSystem.ReadCurrentSystemPosition(EnumStageAxis.BondY));
                }
                ...
                {
                    LeftUpperCornerCoor = new PointF((float)_positioningSystem.ReadCurrentSystemPosition(EnumStageAxis.WaferTableX), (float)_positioningSystem.ReadCurrentSystemPosition(EnumStageAxis.WaferTableY));
                }
                finished = true;
            }
            finally
