...
{
    public partial class ComponentAccuracyStep_RUCorner : ComponentAccuracyStepBasePage
    {
        /// <summary>
        /// 定位系统
        /// </summary>
        ...
        public ComponentAccuracyStep_RUCorner()
        {
            InitializeComponent();
        }
        ...
        {
            get
            { return EnumDefineSetupRecipeComponentAccuracyStep.SetComponentRightUpperCorner; }
        }
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentAccuracyStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeComponentAccuracyStep.SetComponentRightUpperCorner;
