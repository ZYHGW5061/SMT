...
namespace RecipeEditPanelClsLib
{
    ...
    /// 单步定义recipe的UI交互基类
    /// </summary>
    public class ComponentAccuracyStepBasePage : XtraUserControl
    {
        ...
        public virtual EnumDefineSetupRecipeComponentAccuracyStep CurrentStep { get; }
        ...
        /// 验证单步定义是否完成
        /// </summary>
        public virtual void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentAccuracyStep currengStep) 
        { finished = false; currengStep = EnumDefineSetupRecipeComponentAccuracyStep.None; }
