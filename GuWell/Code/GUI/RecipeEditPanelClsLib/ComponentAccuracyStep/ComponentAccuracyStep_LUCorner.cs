...
{
    public partial class ComponentAccuracyStep_LUCorner : ComponentAccuracyStepBasePage
    {
        /// <summary>
        /// 定位系统
        /// </summary>
        ...
        public ComponentAccuracyStep_LUCorner()
        {
            InitializeComponent();
        }
        ...
        {
            get
            { return EnumDefineSetupRecipeComponentAccuracyStep.SetComponentLeftUpperCorner; }
        }
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentAccuracyStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeComponentAccuracyStep.SetComponentLeftUpperCorner;
