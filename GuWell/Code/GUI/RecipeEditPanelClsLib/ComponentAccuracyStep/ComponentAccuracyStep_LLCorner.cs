...
{
    public partial class ComponentAccuracyStep_LLCorner : ComponentAccuracyStepBasePage
    {
        /// <summary>
        /// 定位系统
        /// </summary>
        ...
        public ComponentAccuracyStep_LLCorner()
        {
            InitializeComponent();
        }
        ...
        {
            get
            { return EnumDefineSetupRecipeComponentAccuracyStep.SetComponentLeftLowerCorner; }
        }
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentAccuracyStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeComponentAccuracyStep.SetComponentLeftLowerCorner;
