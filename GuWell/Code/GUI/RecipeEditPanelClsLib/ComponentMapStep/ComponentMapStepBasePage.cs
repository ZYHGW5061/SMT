...
namespace RecipeEditPanelClsLib
{
    ...
    /// 单步定义recipe的UI交互基类
    /// </summary>
    public class ComponentMapStepBasePage : XtraUserControl
    {
        ...
        public virtual EnumDefineSetupRecipeComponentMapStep CurrentStep { get; }
        ...
        public int FirstComponentRowIndex { get; set; }
        public int FirstComponentColumnIndex { get; set; }
        ...
        /// 验证单步定义是否完成
        /// </summary>
        public virtual void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentMapStep currengStep) 
        { finished = false; currengStep = EnumDefineSetupRecipeComponentMapStep.None; }
