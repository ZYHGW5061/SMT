...
{
    public partial class ComponentMapStep_PositionFirstComp : ComponentMapStepBasePage
    {
        ...
        public ComponentMapStep_PositionFirstComp()
        {
            InitializeComponent();
        }
        ...
        {
            get
            { return EnumDefineSetupRecipeComponentMapStep.SetFirstComponentPos; }
        }
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentMapStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeComponentMapStep.SetFirstComponentPos;
