...
{
    public partial class ComponentMapStep_RowParam : ComponentMapStepBasePage
    {
        ...
        public ComponentMapStep_RowParam()
        {
            InitializeComponent();
        }
        ...
        {
            get
            { return EnumDefineSetupRecipeComponentMapStep.SetRowMap; }
        }
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentMapStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeComponentMapStep.SetRowMap;
                ...
                LastRowComponentPosition = new PointF(posX, posY);
                finished = true;
            }
            finally
            {
