...
{
    public partial class ComponentMapStep_SetWaferEdgePoint2 : ComponentMapStepBasePage
    {
        ...
        public ComponentMapStep_SetWaferEdgePoint2()
        {
            InitializeComponent();
            SecondPointDeterminWaferRange = new XYZTCoordinateConfig();

        }
        public override EnumDefineSetupRecipeComponentMapStep CurrentStep
        {
            get
            { return EnumDefineSetupRecipeComponentMapStep.SetDeterminWaferRangeSecondPoint; }
        }
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentMapStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeComponentMapStep.SetDeterminWaferRangeSecondPoint;
                ...
                SecondPointDeterminWaferRange.X = posX;
                SecondPointDeterminWaferRange.Y = posY;
                EditRecipe.CurrentComponent.WaferEdgePos2.X = posX;
                EditRecipe.CurrentComponent.WaferEdgePos2.Y = posY;
                finished = true;
            }
            finally
            {
