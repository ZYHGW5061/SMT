...
{
    public partial class ComponentMapStep_SetWaferEdgePoint1 : ComponentMapStepBasePage
    {
        ...
        public ComponentMapStep_SetWaferEdgePoint1()
        {
            InitializeComponent();
            FirstPointDeterminWaferRange = new XYZTCoordinateConfig();

        }
        public override EnumDefineSetupRecipeComponentMapStep CurrentStep
        {
            get
            { return EnumDefineSetupRecipeComponentMapStep.SetDeterminWaferRangeFirstPoint; }
        }
        ...
        public override void NotifyStepFinished(out bool finished, out EnumDefineSetupRecipeComponentMapStep currentStep)
        {
            try
            {
                currentStep = EnumDefineSetupRecipeComponentMapStep.SetDeterminWaferRangeFirstPoint;
                ...
                FirstPointDeterminWaferRange.X = posX;
                FirstPointDeterminWaferRange.Y = posY;
                EditRecipe.CurrentComponent.WaferEdgePos1.X = posX;
                EditRecipe.CurrentComponent.WaferEdgePos1.Y = posY;
                finished = true;
            }
            finally
            {
