...
{
    public partial class CtrlRGBLight : XtraUserControl
    {
        /// <summary>
        /// 当前暗场光源类型
        /// </summary>
        ...
        private EnumLightColor _curLightColor;
        public EnumLightColor CurrentLightColor
        {
            get { return _curLightColor; }
            set
            {
                _curLightColor = value;             
            }
        }
        /// <summary>
        /// 系统日志记录器
        ...
        private ILightSourceController _controller
        {
            get
            {
                ...
                {
                    if (_curLightColor == EnumLightColor.Red)
                    {
                        return HardwareManager.Instance.WaferDirectRedLightController;
                    }
                    else if (_curLightColor == EnumLightColor.Green)
                    {
                        return HardwareManager.Instance.WaferDirectGreenLightController;
                    }
                    else if (_curLightColor == EnumLightColor.Blue)
                    {
                        return HardwareManager.Instance.WaferDirectBlueLightController;
                    }
                    else
                    {
        ...
        {
            InitializeComponent();
            cmbSelectLightColor.SelectedIndex = 0;
        ...
        private void cmbSelectLightColor_SelectedIndexChanged(object sender, EventArgs e)
        {
            EnumLightColor curColor = EnumLightColor.Red;
            Enum.TryParse(cmbSelectLightColor.Text, out curColor);
            _curLightColor = curColor;
        }
    }
}
