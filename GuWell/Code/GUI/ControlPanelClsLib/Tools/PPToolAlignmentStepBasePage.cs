...
namespace ControlPanelClsLib
{
    ...
    /// 单步定义recipe的UI交互基类
    /// </summary>
    public class PPToolAlignmentStepBasePage : XtraUserControl
    {
        ...
        public virtual EnumDefinePPAlignStep CurrentStep { get; }

        /// <summary>
        /// 特征的系统坐标系位置
        /// </summary>
        public XYZTCoordinateConfig CenterPosition { get; set; }
        ...
        /// 验证单步定义是否完成
        /// </summary>
        public virtual void NotifyStepFinished(out bool finished, out EnumDefinePPAlignStep currengStep) 
        { finished = false; currengStep = EnumDefinePPAlignStep.None; }
