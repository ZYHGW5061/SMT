...
{
    public partial class FrmStageControl2 : DevExpress.XtraEditors.XtraForm
    {

        public FrmStageControl2()
        {
            InitializeComponent();
        ...
        private void UpdateLabel2(int row, int column, string newText, Color newColor, bool enable = true)
        {
            // 获取指定行列的控件  
            Control control = tableLayoutPanel4.GetControlFromPosition(column, row);
        ...
        {
            UpdateLabel2((int)axis, 0, name, Color.Transparent, enable);
        }

        private void UpdatePosition(EnumStageAxis axis, double position)
        {
            UpdateLabel2((int)axis, 1, position.ToString("F3"), Color.Transparent);
        ...
        private void ReadAxis()
        {
            ...
            double speed = _axisConfig.AxisSpeed;
            ...
            double acceleration = _axisConfig.Acceleration;
            ...
            double deceleration = _axisConfig.Deceleration;
            ...
            double LeftLimit = _axisConfig.SoftLeftLimit;
            ...
            double RightLimit = _axisConfig.SoftRightLimit;
        ...
        private void btnEnable_Click(object sender, EventArgs e)
        {
            ...
            LogRecorder.RecordUserOperationLog($"设置轴:{_currentStageAxis} 使能", WestDragon.Framework.BaseLoggerClsLib.EnumLogContentType.Info, UserManager.Instance.CurrentUserName);
        }
        ...
        private void btnDisable_Click(object sender, EventArgs e)
        {
            ...
            LogRecorder.RecordUserOperationLog($"设置轴:{_currentStageAxis} 去使能", WestDragon.Framework.BaseLoggerClsLib.EnumLogContentType.Info, UserManager.Instance.CurrentUserName);
        }
        ...
        private void btnErrorClear_Click(object sender, EventArgs e)
        {
            ...
            LogRecorder.RecordUserOperationLog($"设置轴:{_currentStageAxis} 错误清除", WestDragon.Framework.BaseLoggerClsLib.EnumLogContentType.Info, UserManager.Instance.CurrentUserName);
        }
        ...
        private void btnStop_Click(object sender, EventArgs e)
        {
            ...
            LogRecorder.RecordUserOperationLog($"设置轴:{_currentStageAxis} 急停", WestDragon.Framework.BaseLoggerClsLib.EnumLogContentType.Info, UserManager.Instance.CurrentUserName);
        }
        ...
        private void btnLimitEffective_Click(object sender, EventArgs e)
        {
            ...
            LogRecorder.RecordUserOperationLog($"设置轴:{_currentStageAxis} 限位有效", WestDragon.Framework.BaseLoggerClsLib.EnumLogContentType.Info, UserManager.Instance.CurrentUserName);
        }
        ...
        private void btnLimitFailure_Click(object sender, EventArgs e)
        {
            ...
            LogRecorder.RecordUserOperationLog($"设置轴:{_currentStageAxis} 限位无效", WestDragon.Framework.BaseLoggerClsLib.EnumLogContentType.Info, UserManager.Instance.CurrentUserName);
        }
        ...
        private void btnGoHome_Click(object sender, EventArgs e)
        {
            if (_boardCardController != null)
            {
                ...
                //}
                LogRecorder.RecordUserOperationLog($"设置轴:{_currentStageAxis} 回零", WestDragon.Framework.BaseLoggerClsLib.EnumLogContentType.Info, UserManager.Instance.CurrentUserName);
            }
        }
        ...
        private void btnSetZero_Click(object sender, EventArgs e)
        {
            if (_boardCardController != null)
            {
                ...
                LogRecorder.RecordUserOperationLog($"设置轴:{_currentStageAxis} 零点", WestDragon.Framework.BaseLoggerClsLib.EnumLogContentType.Info, UserManager.Instance.CurrentUserName);
            }
        }

        private void numSpeed_ValueChanged(object sender, EventArgs e)
        {
            double speed = double.Parse(numSpeed.Text);
            _boardCardController.SetAxisSpeed(_currentStageAxis, speed);
            LogRecorder.RecordUserOperationLog($"设置轴:{_currentStageAxis} 速度为:{speed}mm/s", WestDragon.Framework.BaseLoggerClsLib.EnumLogContentType.Info, UserManager.Instance.CurrentUserName);
        }

        private void numSoftLeftLimit_ValueChanged(object sender, EventArgs e)
        {
            double SoftLeftLimit = double.Parse(numSoftLeftLimit.Text);
            double SoftRightLimit = double.Parse(numSoftRightLimit.Text);
            _boardCardController.SetSoftLeftAndRightLimit(_currentStageAxis, SoftRightLimit, SoftLeftLimit);
            LogRecorder.RecordUserOperationLog($"设置轴:{_currentStageAxis} 左限位为:{SoftRightLimit}", WestDragon.Framework.BaseLoggerClsLib.EnumLogContentType.Info, UserManager.Instance.CurrentUserName);
        }

        private void numSoftRightLimit_ValueChanged(object sender, EventArgs e)
        {
            double SoftLeftLimit = double.Parse(numSoftLeftLimit.Text);
            double SoftRightLimit = double.Parse(numSoftRightLimit.Text);
            _boardCardController.SetSoftLeftAndRightLimit(_currentStageAxis, SoftRightLimit, SoftLeftLimit);
            LogRecorder.RecordUserOperationLog($"设置轴:{_currentStageAxis} 右限位为:{SoftRightLimit}", WestDragon.Framework.BaseLoggerClsLib.EnumLogContentType.Info, UserManager.Instance.CurrentUserName);
        }

        private void FrmStageControl2_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
        ...
        private void FrmStageControl2_Load(object sender, EventArgs e)
        {
            foreach (var item in Enum.GetValues(typeof(EnumStageAxis)))
            {
                this.comboBoxSelAxis.Items.Add(item);
