...
namespace ProductRunClsLib
{
    public class ProductExecutor : INotifyPropertyChanged
    {
        ...
        public bool CurChipIsonPPtool
        {
            get
            {
                return curChipIsonPPtool;
            }
            set
            {
                curChipIsonPPtool = value;
                //PropertyChanged?.Invoke(this, new PropertyChangedEventArgs("CurSubNum"));
            }
        }
        private bool curSubmonutIsonPPtool = false;
        public bool CurSubmonutIsonPPtool
        {
            get
            {
                return curSubmonutIsonPPtool;
            }
            set
            {
                curSubmonutIsonPPtool = value;
                //PropertyChanged?.Invoke(this, new PropertyChangedEventArgs("CurSubNum"));
            }
        }
        ...
        private int curSubmonutNum = 1;
        public int CurSubmonutNum
        {
            get
            {
                return curSubmonutNum;
            }
            set
            {
                curSubmonutNum = value;
                //PropertyChanged?.Invoke(this, new PropertyChangedEventArgs("CurSubNum"));
            }
        }
        ...
        private int curSubmonutNGNum = 0;
        /// <summary>
        /// 当前NG衬底数量
        /// </summary>
        public int CurSubmonutNGNum
        {
            get
            {
                return curSubmonutNGNum;
            }
            set
            {
                curSubmonutNGNum = value;
                //PropertyChanged?.Invoke(this, new PropertyChangedEventArgs("CurSubNum"));
            }
        }
        ...
        private double materialSubmonutLocationOffsetX = 0;
        /// <summary>
        /// 衬底物料起点X偏移
        /// </summary>
        public double MaterialSubmonutLocationOffsetX
        {
            get
            {
                return materialSubmonutLocationOffsetX;
            }
            set
            {
                materialSubmonutLocationOffsetX = value;
                //PropertyChanged?.Invoke(this, new PropertyChangedEventArgs("CurSubNum"));
            }
        }

        private double materialSubmonutLocationOffsetY = 0;
        /// <summary>
        /// 衬底物料起点Y偏移
        /// </summary>
        public double MaterialSubmonutLocationOffsetY
        {
            get
            {
                return materialSubmonutLocationOffsetY;
            }
            set
            {
                materialSubmonutLocationOffsetY = value;
                //PropertyChanged?.Invoke(this, new PropertyChangedEventArgs("CurSubNum"));
            }
        }
        ...
        //共晶前识别衬底的贴装位置偏移 芯片前校准结果
        public XYZTCoordinateConfig OffsetBeforeEutecticChip { get; set; }

        //贴装芯片前校准结果
        public XYZTCoordinateConfig OffsetAfterChipAccuracy { get; set; }

        //贴装芯片前校准结果
        public XYZTCoordinateConfig OffsetAfterSubmonutAccuracy { get; set; }
        ...
        public void Execute()
        {
            ...
            if (_positionSystem.BondMovetoSafeLocation())
            {
                ...
                Task.Factory.StartNew(new Action(() =>
                {
                    ...
                    EnumJobRunStatus currentPositionComponentStatus = EnumJobRunStatus.Initial;
                    ...
                    foreach (ProductStep step in ProductSteps)
                    {
                        ...
                        if (SystemConfiguration.Instance.JobConfig.WaferQuickMode)
                        {
                            ...
                            (ProductRecipe.CurrentComponent.CarrierType == EnumCarrierType.Wafer || ProductRecipe.CurrentComponent.CarrierType == EnumCarrierType.WaferWafflePack))
                            {
                        ...
                        else if(step.productStepType == EnumProductStepType.CalibrationAfterPP)
                        {
                            while (true && RunStat != EnumProductRunStat.Stop && RunStat != EnumProductRunStat.UserAbort)
                            {
                                //if (currentJobStatus == EnumJobRunStatus.Completed || currentJobStatus == EnumJobRunStatus.Aborted)
